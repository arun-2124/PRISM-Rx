...
with conn.cursor() as cur:
    print("Altering evidence_events text column types in Postgres...")
    cur.execute("ALTER TABLE evidence_events ALTER COLUMN event_type TYPE TEXT;")
    cur.execute("ALTER TABLE evidence_events ALTER COLUMN description TYPE TEXT;")
    cur.execute("ALTER TABLE evidence_events ALTER COLUMN source TYPE TEXT;")
conn.commit()
